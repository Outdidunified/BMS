...
const logFilename = path.join(logsDirectory, 'DeviceSimulator.log');
...
export const loggerInfo = (message) => baseLogger.info(message);
export const loggerError = (message) => baseLogger.error(message);
export const loggerWarn = (message) => baseLogger.warn(message);
export const loggerSuccess = (message) => baseLogger.log('success', message);
export const loggerDebug = (message) => baseLogger.log('debug', message);
export const loggerPingPong = (message) => baseLogger.log('pingpong', message);

export default { loggerInfo, loggerError, loggerWarn, loggerSuccess, loggerDebug, loggerPingPong };
